...
+(void)shareandImageList:(NSArray *)arr{
    
  [[UIApplication sharedApplication].keyWindow addSubview:  [[[PageControlView class] instance]initWithFrame:[UIScreen mainScreen].bounds andImageList:arr]];
...
//    NSString *path = [[NSBundle bundleForClass:[self class]] pathForResource:<#(nullable NSString *)#> ofType:<#(nullable NSString *)#>];
